...
@par CRC_8BitsCRCMessage Description 

This example aims to show how to use the CRC peripheral in order to compute
8-bit CRC checksum of a message.
The CRC peripheral is configured to use the 8-bit CRC polynomial
x8 + x7 + x6 + x4 + x2 + 1 with the initialization value is set to 0.
...
@par Directory contents 
  ...
  - CRC_8BitsCRCMessage/stm32f0xx_conf.h    Library Configuration file
  - CRC_8BitsCRCMessage/stm32f0xx_it.c      Interrupt handlers
  - CRC_8BitsCRCMessage/stm32f0xx_it.h      Interrupt handlers header file
  - CRC_8BitsCRCMessage/main.c              Main program
  - CRC_8BitsCRCMessage/system_stm32f0xx.c  STM32F0xx system source file
