/**
  ******************************************************************************
  * @file    stm32f072b_discovery_l3gd20.c
  * @author  MCD Application Team
  * @version V1.0.0
  * @date    27-December-2013
  * @brief   This file provides a set of functions needed to manage the l3gd20
  *          MEMS accelerometer available on STM32F072B-DISCO Kit.
  ******************************************************************************
  * @attention
  *
...
/** @defgroup STM32F072B_DISCOVERY_L3GD20_Private_TypesDefinitions
  * @{
  */
...
/** @defgroup STM32F072B_DISCOVERY_L3GD20_Private_Defines
  * @{
  */
...
/** @defgroup STM32F072B_DISCOVERY_L3GD20_Private_Macros
  * @{
  */
...
/** @defgroup STM32F072B_DISCOVERY_L3GD20_Private_Variables
  * @{
  */ 
...
/** @defgroup STM32F072B_DISCOVERY_L3GD20_Private_FunctionPrototypes
  * @{
  */
...
/** @defgroup STM32F072B_DISCOVERY_L3GD20_Private_Functions
  * @{
  */
...
static void L3GD20_LowLevel_Init(void)
{
  ...
  RCC_APB1PeriphClockCmd(L3GD20_SPI_CLK, ENABLE);
  ...
  because L3GD20 MEMS SPI interface max baudrate is 10MHz for write and read */
