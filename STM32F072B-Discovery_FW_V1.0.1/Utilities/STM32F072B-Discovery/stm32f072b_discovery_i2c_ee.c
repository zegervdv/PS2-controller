/**
  ******************************************************************************
  * @file    stm32f072b_discovery_i2c_ee.c
  ...
  *             board (ANT7-M24LR-A) which is not provided with the STM32F072B-DISCO board. 
  *             ANT7-M24LR-A should be plugged into connector CN3 of STM32F072B-DISCO board.
  *          ===================================================================
  *              
  *          It implements a high level communication layer for read and write 
  *          from/to this memory. The needed STM32F0xx hardware resources (I2C and 
  *          GPIO) are defined in stm32072b_discovery.h file, and the initialization is 
  *          performed in sEE_LowLevel_Init() function declared in stm32072b_discovery.c 
  *          file.
...
/** @addtogroup STM32F072B_DISCOVERY_I2C_EE
  * @brief      This file includes the I2C EEPROM driver of STM32F072B_DISCO board.
  * @{
  */ 

/** @defgroup STM32F072B_DISCOVERY_I2C_EE_Private_Types
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM32F072B_DISCOVERY_I2C_EE_Private_Defines
  * @{
  */  
/**
  * @}
...
/** @defgroup STM32F072B_DISCOVERY_I2C_EE_Private_Macros
  * @{
  */
/**
  * @}
...
/** @defgroup STM32F072B_DISCOVERY_I2C_EE_Private_Variables
  * @{
  */
...
/** @defgroup STM32F072B_DISCOVERY_I2C_EE_Private_Function_Prototypes
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM32F072B_DISCOVERY_I2C_EE_Private_Functions
  * @{
  */ 
...
uint32_t sEE_WaitEepromStandbyState(void)      
{
  ...
  in stm32f072b_discovery_i2c_ee.h file) */
...
void sEE_LowLevel_DeInit(void)
{
  ...
  /* Disable sEE_I2C Peripheral */
  I2C_Cmd(sEE_I2C, DISABLE);
 
  /* DeInitialize sEE_I2C */
  I2C_DeInit(sEE_I2C);

  /* Disable sEE_I2C Periph clock */
  RCC_APB1PeriphClockCmd(sEE_I2C_CLK, DISABLE);
 
  /* Configure sEE_I2C SCL pin */
  GPIO_InitStructure.GPIO_Pin = sEE_I2C_SCL_PIN;
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN;  
  GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_NOPULL;
  GPIO_Init(sEE_I2C_SCL_GPIO_PORT, &GPIO_InitStructure);

  /* Configure sEE_I2C SDA pin */
  GPIO_InitStructure.GPIO_Pin = sEE_I2C_SDA_PIN;
  GPIO_Init(sEE_I2C_SDA_GPIO_PORT, &GPIO_InitStructure);
}

/**
  * @brief  Initializes the I2C source clock and IOs used to drive the I2C EEPROM.
  * @param  None
  * @retval None
  */
