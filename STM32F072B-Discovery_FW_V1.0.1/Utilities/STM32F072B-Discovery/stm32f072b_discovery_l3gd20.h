/**
  ******************************************************************************
  * @file    stm32f072b_discovery_l3gd20.h
  * @author  MCD Application Team
  * @version V1.0.0
  * @date    27-December-2013
  * @brief   This file contains definitions for stm32f072b_discovery_l3gd20.c 
  *          firmware driver.
  ******************************************************************************
  * @attention
  *
...
#ifndef __STM32F072B_DISCOVERY_L3GD20_H
#define __STM32F072B_DISCOVERY_L3GD20_H
...
/** @addtogroup STM32F072B_DISCOVERY_L3GD20
  * @{
  */
  
/** @defgroup STM32F072B_DISCOVERY_L3GD20_Exported_Types
  * @{
  */
...
/** @defgroup STM32F072B_DISCOVERY_L3GD20_Exported_Constants
  * @{
  */
...
/* Uncomment the following line to use the default L3GD20_TIMEOUT_UserCallback() 
   function implemented in stm32f072b_discovery_lgd20.c file.
   L3GD20_TIMEOUT_UserCallback() function is called whenever a timeout condition 
   occur during communication (waiting transmit data register empty flag(TXE)
...
#define L3GD20_SPI_CLK                   RCC_APB1Periph_SPI2

#define L3GD20_SPI_SCK_PIN               GPIO_Pin_13                  /* PB.13 */
#define L3GD20_SPI_SCK_GPIO_PORT         GPIOB                       /* GPIOB */
#define L3GD20_SPI_SCK_GPIO_CLK          RCC_AHBPeriph_GPIOB
#define L3GD20_SPI_SCK_SOURCE            GPIO_PinSource13
#define L3GD20_SPI_SCK_AF                GPIO_AF_0

#define L3GD20_SPI_MISO_PIN              GPIO_Pin_14                  /* PB.14 */
#define L3GD20_SPI_MISO_GPIO_PORT        GPIOB                       /* GPIOB */
#define L3GD20_SPI_MISO_GPIO_CLK         RCC_AHBPeriph_GPIOB
#define L3GD20_SPI_MISO_SOURCE           GPIO_PinSource14
#define L3GD20_SPI_MISO_AF               GPIO_AF_0

#define L3GD20_SPI_MOSI_PIN              GPIO_Pin_15                  /* PB.15 */
#define L3GD20_SPI_MOSI_GPIO_PORT        GPIOB                       /* GPIOB */
#define L3GD20_SPI_MOSI_GPIO_CLK         RCC_AHBPeriph_GPIOB
#define L3GD20_SPI_MOSI_SOURCE           GPIO_PinSource15
#define L3GD20_SPI_MOSI_AF               GPIO_AF_0

#define L3GD20_SPI_CS_PIN                GPIO_Pin_0                  /* PC.00 */
#define L3GD20_SPI_CS_GPIO_PORT          GPIOC                       /* GPIOC */
#define L3GD20_SPI_CS_GPIO_CLK           RCC_AHBPeriph_GPIOC

#define L3GD20_SPI_INT1_PIN              GPIO_Pin_1                  /* PC.01 */
#define L3GD20_SPI_INT1_GPIO_PORT        GPIOC                       /* GPIOC */
#define L3GD20_SPI_INT1_GPIO_CLK         RCC_AHBPeriph_GPIOC
#define L3GD20_SPI_INT1_EXTI_LINE        EXTI_Line1
#define L3GD20_SPI_INT1_EXTI_PORT_SOURCE EXTI_PortSourceGPIOC
#define L3GD20_SPI_INT1_EXTI_PIN_SOURCE  EXTI_PinSource1
#define L3GD20_SPI_INT1_EXTI_IRQn        EXTI0_1_IRQn 

#define L3GD20_SPI_INT2_PIN              GPIO_Pin_2                  /* PC.02 */
#define L3GD20_SPI_INT2_GPIO_PORT        GPIOC                       /* GPIOC */
#define L3GD20_SPI_INT2_GPIO_CLK         RCC_AHBPeriph_GPIOC
#define L3GD20_SPI_INT2_EXTI_LINE        EXTI_Line2
#define L3GD20_SPI_INT2_EXTI_PORT_SOURCE EXTI_PortSourceGPIOC
#define L3GD20_SPI_INT2_EXTI_PIN_SOURCE  EXTI_PinSource2
#define L3GD20_SPI_INT2_EXTI_IRQn        EXTI2_3_IRQn 
...
/** @defgroup Latch_Interrupt_Request_Status 
  * @{
  */
#define L3GD20_LATCH_ENABLE       ((uint8_t)0x40)
#define L3GD20_LATCH_DISABLE      ((uint8_t)0x00)
/**
  * @}
  */
...
/** @defgroup STM32F072B_DISCOVERY_L3GD20_Exported_Macros
  * @{
  */
...
/** @defgroup STM32F072B_DISCOVERY_L3GD20_Exported_Functions
  * @{
  */
...
/* USER Callbacks: This is function for which prototype only is declared in
   MEMS accelerometer driver and that should be implemented into user application. */  
/* L3GD20_TIMEOUT_UserCallback() function is called whenever a timeout condition 
   occur during communication (waiting transmit data register empty flag(TXE)
   or waiting receive data register is not empty flag (RXNE)).
   You can use the default timeout callback implementation by uncommenting the 
   define USE_DEFAULT_TIMEOUT_CALLBACK in stm32f072b_discovery_l3gd20.h file.
...
#endif /* __STM32F072B_DISCOVERY_L3GD20_H */
