...
uint8_t  USBD_CCID_Init (void  *pdev, 
                            uint8_t cfgidx);

uint8_t  USBD_CCID_DeInit (void  *pdev, 
                              uint8_t cfgidx);

uint8_t  USBD_CCID_Setup (void  *pdev, 
                             USB_SETUP_REQ *req);

uint8_t  USBD_CCID_DataIn (void  *pdev, 
                              uint8_t epnum);
...
uint8_t  *USBD_CCID_GetCfgDesc (uint8_t speed, 
                                      uint16_t *length);
...
/**
  ...
  * @retval status
  */
uint8_t  USBD_CCID_Setup (void  *pdev, USB_SETUP_REQ *req)
{
  uint8_t slot_nb;
  uint8_t seq_nb;
  uint16_t len;
...
/**
  ...
  */
uint8_t  *USBD_CCID_GetCfgDesc (uint8_t speed, uint16_t *length)
{
