...
/** @defgroup USBD_PWR
* @brief    This file provides power management functions
* @{
*/

/** @defgroup USBD_PWR_Private_TypesDefinitions
* @{
*/
/**
* @}
...
/** @defgroup USBD_PWR_Private_Defines
* @{
*/
/**
* @}
...
/** @defgroup USBD_PWR_Private_Macros
* @{
*/
/**
* @}
...
/** @defgroup USBD_PWR_Private_Variables
* @{
*/
...
/** @defgroup USBD_PWR_Private_Constants
* @{
*/
...
/** @defgroup USBD_PWR_Private_FunctionPrototypes
* @{
*/
/**
* @}
...
/** @defgroup USBD_PWR_Private_Functions
* @{
*/
...
void Leave_LowPowerMode(void) {
...
#ifndef USB_CLOCK_SOURCE_CRS

  /* After wake-up from STOP mode restore USB clock source (USB clock = PLL clock
  from HSE source )*/
  /* Enable HSE */
  ...
  RCC_PLLConfig(RCC_PLLSource_HSE, RCC_PLLMul_8);
  /* Enable PLL */
  RCC_PLLCmd(ENABLE);
